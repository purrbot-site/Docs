...
- <!-- md-badge:optional `Dateien anhängen` --> - Benötigt um ein Bild anzuhängen.
...
- <!-- md-badge:optional `Dateien anhängen` -->  
...
- <!-- md-badge:optional `bg set {hintergrund}` -->  
...
- <!-- md-badge:optional `channel set {#kanal}` -->  
...
- <!-- md-badge:optional `color set {farbe}` -->  
...
- <!-- md-badge:optional `msg set {nachricht}` -->  
